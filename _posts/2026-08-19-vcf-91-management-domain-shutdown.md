...
description: A modular PowerCLI framework that walks a VCF 9.1 management domain through Broadcom's documented shutdown sequence, built so isolated VCD lab pods can be safely converted back into reusable vApp Templates.
author: samui
date: 2026-08-19
categories:
...
- vcf
image:
  path: /images/2026/08/vcf91-shutdown-script.png
